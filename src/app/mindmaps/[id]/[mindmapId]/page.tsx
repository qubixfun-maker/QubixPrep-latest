...
export default function MindmapImageUnavailablePage() {
    ...
    <div className="h-[80vh] flex flex-col items-center justify-center p-6 text-center gap-4">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2 max-w-md">
          We are doing some maintenance on this section. Check back soon - everything else in QubixPrep is working as normal.
        </p>
      </div>
