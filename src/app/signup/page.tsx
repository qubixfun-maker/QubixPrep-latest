    ...
    try {
      ...
      setDoc(userRef, {
        ...
        const permissionError = new FirestorePermissionError({
          path: userRef.path,
          operation: 'create',
          requestResourceData: { mobileNumber: formData.mobile, collegeName: formData.college, currentYear: formData.year }
        });
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <Card className="w-full max-w-md glass border-none shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
        ...
        <CardContent className="space-y-4">
          ...
          <Button variant="outline" className="w-full glass border-white/10 h-12" onClick={handleGoogleSignIn}>
