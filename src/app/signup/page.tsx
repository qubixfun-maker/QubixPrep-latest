...
import { BrainCircuit, Loader2, Mail, Lock, User, Phone, School } from "lucide-react"
    ...
    try {
      ...
      setDoc(userRef, {
        ...
        const permissionError = new FirestorePermissionError({
          path: userRef.path,
          operation: 'create',
          requestResourceData: { mobileNumber: formData.mobile, collegeName: formData.college }
        });
      ...
      <Card className="w-full max-w-md glass border-none shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-2">
            <Button variant="outline" className="glass border-white/10 h-12" onClick={handleGoogleSignIn}>
